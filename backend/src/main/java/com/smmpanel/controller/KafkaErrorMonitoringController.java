 ...
 *
 * <p>Provides endpoints for monitoring Kafka error handling: 1. Error metrics and statistics 2.
 * Consumer container health status 3. Dead letter queue monitoring 4. Error handler configuration
 * details 5. Manual error recovery operations
 */
@Slf4j
@RestController
...
@Tag(
        name = "Kafka Error Monitoring",
        description = "Kafka error handling monitoring and management endpoints")
...
public class KafkaErrorMonitoringController {
    ...
    @GetMapping("/metrics")
    @Operation(
            summary = "Get Kafka error metrics",
    ...
    public ResponseEntity<Map<String, Object>> getErrorMetrics() {
        ...
        try {
            ...
            Map<String, Object> metrics =
                    (Map<String, Object>) errorConfiguration.kafkaErrorMetrics();
    ...
    @GetMapping("/health")
    @Operation(
            summary = "Get Kafka consumer health status",
    ...
    public ResponseEntity<Map<String, Object>> getConsumerHealth() {
        ...
        try {
            ...
            for (MessageListenerContainer container : endpointRegistry.getListenerContainers()) {
                totalContainers++;
                String containerId =
                        container.getGroupId() != null
                                ? container.getGroupId()
                                : "unknown-" + totalContainers;
    ...
    @Operation(
            summary = "Get error handler configuration",
        ...
        try {
            ...
            config.put(
                    ...
                    Map.of(
                            ...
                            "nonRetryableExceptions",
                                    Map.of(
                                            "serialization",
                                            "DeserializationException, JsonParseException",
                                            "validation",
            ...
            config.put(
                    ...
                    Map.of(
                            ...
                            true,
                            "topicMapping",
                            "Auto-generated .dlq suffix",
                            "messageEnhancement",
                            "Adds error metadata and headers",
                            "retentionDays",
                            30));
    ...
    @Operation(
            summary = "Restart consumer container",
    ...
    @Operation(
            summary = "Restart all consumer containers",
    ...
    @Operation(
            summary = "Get recent error summary",
 ...
 *
 * <p>Custom actuator endpoint for Kafka error monitoring
 */
