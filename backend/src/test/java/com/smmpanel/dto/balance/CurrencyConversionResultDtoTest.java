...
class CurrencyConversionResultDtoTest {
    ...
    void fromRequest_WithRequest_SetsCorrectFields() {
        ...
        CurrencyConversionResultDto dto = CurrencyConversionResultDto.from(request)
    ...
    void fromParams_WithParams_SetsCorrectFields() {
        CurrencyConversionResultDto dto = CurrencyConversionResultDto.from(
                new BigDecimal("100"),
                "USD",
                "EUR",
                true
    ...
    void builder_WithFormatFalse_ExcludesFormattedAmount() {
        CurrencyConversionResultDto dto = CurrencyConversionResultDto.builder()
    ...
    void equalsAndHashCode_WithSameValues_AreEqual() {
        CurrencyConversionResultDto dto1 = CurrencyConversionResultDto.builder()
                .amount(new BigDecimal("100"))
                .fromCurrency("USD")
                .toCurrency("EUR")
                .exchangeRate(new BigDecimal("0.85"))
        ...
        CurrencyConversionResultDto dto2 = CurrencyConversionResultDto.builder()
                .amount(new BigDecimal("100"))
                .fromCurrency("USD")
                .toCurrency("EUR")
                .exchangeRate(new BigDecimal("0.85"))
