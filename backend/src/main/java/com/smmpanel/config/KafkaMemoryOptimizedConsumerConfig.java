...
/**
 * Memory-Optimized Kafka Consumer Configuration Configures Kafka consumers with optimal memory
 * settings and monitoring
 */
@Configuration
public class KafkaMemoryOptimizedConsumerConfig {

    @Autowired private KafkaConsumerMemoryConfig memoryConfig;

    @Autowired private MemoryMonitoringService memoryMonitoringService;
    ...
    public ConsumerFactory<String, Object> memoryOptimizedConsumerFactory() {
        ...
        props.put(
                ...
                memoryConfig.getMaxPartitionFetchBytes());
    ...
    public ConcurrentKafkaListenerContainerFactory<String, Object>
            memoryOptimizedKafkaListenerContainerFactory() {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, Object>
            batchMemoryOptimizedKafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, Object> factory =
                new ConcurrentKafkaListenerContainerFactory<>();
        factory.setConsumerFactory(memoryOptimizedConsumerFactory());
