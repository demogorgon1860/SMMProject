...
/**
 * Global exception handler for optimistic locking failures Provides consistent error responses for
...
public class OptimisticLockingExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Map<String, Object>>> handleOptimisticLockingFailure(
        ...
        log.warn(
                "Optimistic locking failure in request: {} {}",
                request.getMethod(),
        ...
        if (exceptionMessage != null) {
            if (exceptionMessage.toLowerCase().contains("user")) {
                ...
                errorDetails.put(
                        "specificMessage", "Transaction was modified by another operation");
            }
        }
    ...
    public ResponseEntity<ApiResponse<Map<String, Object>>> handleCustomOptimisticLockingException(
        ...
        log.error(
                "Custom optimistic locking exception in request: {} {}",
                request.getMethod(),
                request.getRequestURI(),
                ex);
        ...
        ApiResponse<Map<String, Object>> response =
                ApiResponse.<Map<String, Object>>builder()
                        .success(false)
                        .message(
                                "Operation failed due to concurrent modifications - retry limit"
                                        + " exceeded")
                        .data(errorDetails)
                        .build();
    ...
    public ResponseEntity<ApiResponse<Map<String, Object>>> handleConcurrentModification(
        ...
        if (exceptionMessage != null
            ...
            log.warn(
                    "Potential concurrent modification issue in request: {} {}",
                    request.getMethod(),
                    request.getRequestURI(),
                    ex);
