...
/**
 * Enhanced Redis Configuration with Caching
 * Provides Redis caching with different TTLs for different cache types
 */
@Configuration
@EnableCaching
public class RedisConfig {
    ...
    public CacheManager cacheManager(RedisConnectionFactory connectionFactory) {
        ...
        cacheConfigurations.put("start_count", 
            RedisCacheConfiguration.defaultCacheConfig()
        ...
        cacheConfigurations.put("balance", 
            RedisCacheConfiguration.defaultCacheConfig()
        ...
        cacheConfigurations.put("youtube-views", 
            RedisCacheConfiguration.defaultCacheConfig()
                .entryTtl(Duration.ofMinutes(5))
                .serializeKeysWith(RedisSerializationContext.SerializationPair.fromSerializer(new StringRedisSerializer()))
                .serializeValuesWith(RedisSerializationContext.SerializationPair.fromSerializer(new GenericJackson2JsonRedisSerializer())));
