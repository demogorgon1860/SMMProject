...
/**
 * Processing strategy for YouTube orders. Defines different approaches to processing orders with
 * their respective coefficients.
 */
public enum ProcessingStrategy {

    /**
     * Clip-based processing strategy. Creates a YouTube clip from the original video for traffic
     * routing. Lower coefficient due to higher conversion rate from clips.
     */
    CLIP_BASED(3.0),

    /**
     * Direct traffic processing strategy. Routes traffic directly to the original video without
     * creating clips. Higher coefficient due to lower conversion rate.
     */
    DIRECT_TRAFFIC(4.0);
