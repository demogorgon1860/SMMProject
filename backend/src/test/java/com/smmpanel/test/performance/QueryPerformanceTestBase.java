...
/**
 * Base class for query performance testing with actual SQL query counting Provides utilities for
 * creating test data and measuring query performance
 */
@SpringBootTest
@ActiveProfiles("test")
@Transactional
...
public abstract class QueryPerformanceTestBase {
    ...
    public void setupQueryPerformanceTesting() {
        ...
        log.info(
                "Performance thresholds: Order Creation={}, Order Listing={}, Single Fetch={}",
                maxQueriesOrderCreation,
                maxQueriesOrderListing,
                maxQueriesSingleOrderFetch);
    }

    /** Measure query performance for a given operation */
    protected QueryPerformanceResult measureQueryPerformance(
        ...
        QueryPerformanceResult result =
                QueryPerformanceResult.builder()
                        ...
                        .cacheHitCount(
                                finalSecondLevelCacheHitCount - initialSecondLevelCacheHitCount)
    ...
    protected void assertQueryCountWithinLimit(QueryPerformanceResult result, int maxQueries) {
        ...
        log.info(
                "✓ Query count assertion passed for {}: {} <= {}",
        ...
        for (int i = 0; i < count; i++) {
            Service service =
                    Service.builder()
                            ...
                            .pricePer1000(
                                    BigDecimal.valueOf(0.5 + random.nextDouble() * 4.5)) // 0.5-5.0
    ...
    protected List<Order> createTestOrders(
            List<User> users, List<Service> services, int ordersPerUser) {
    ...
    protected void logHibernateStats(String context) {
        log.info(
                "Hibernate Stats [{}]: Queries={}, Entities={}, Collections={}, Cache Hits={},"
                        + " Sessions={}",
                context,
