...
class CurrencyServiceTest {
    ...
    @BeforeEach
    void setUp() {
        // Set the required fields using ReflectionTestUtils since constructor requires
        // UserRepository
        ...
        CurrencyConversionResponse mockResponse =
                CurrencyConversionResponse.builder()
                        .success(true)
    ...
    void fetchLatestRates_UpdatesExchangeRates() {
        ...
        assertFalse(
                ((Map<?, ?>) ReflectionTestUtils.getField(currencyService, "exchangeRates"))
                        .isEmpty());
    }
}
