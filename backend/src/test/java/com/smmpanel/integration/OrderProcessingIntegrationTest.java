...
/** Order Processing Integration Test Tests the full order flow from creation to completion */
@SpringBootTest
@ActiveProfiles("test")
@Transactional
...
public class OrderProcessingIntegrationTest {
    ...
    void testFullOrderFlow() throws Exception {
        ...
        assertTrue(
                updatedOrder.getStatus() == OrderStatus.PROCESSING
                                ...
                                try {
                                    ...
                                    OrderCreatedEvent event =
                                            new OrderCreatedEvent(
                                                    this, order.getId(), testUser.getId());
                                    eventPublisher.publishEvent(event);
                                    latch.countDown();
                                } catch (Exception e) {
                                    e.printStackTrace();
