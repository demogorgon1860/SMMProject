 ...
 *
 * <p>Features: 1. Complete order information with related data 2. Prevents N+1 queries through
 * joins 3. Optimized for API responses and detailed views 4. Includes video processing information
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
