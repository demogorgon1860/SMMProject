 ...
 * 1. Custom circuit breaker configurations for different services
 * 2. Retry patterns with exponential backoff
 * 3. Proper event listeners for monitoring
 * 4. Fallback strategies for external services
 */
@Slf4j
@Configuration
public class Resilience4jConfig {
    ...
    public CircuitBreakerRegistry circuitBreakerRegistry() {
        ...
        CircuitBreakerConfig binomConfig = CircuitBreakerConfig.custom()
                .failureRateThreshold(50.0f)                    // Open if 50% of calls fail
                .slowCallRateThreshold(50.0f)                   // Open if 50% of calls are slow
                .slowCallDurationThreshold(Duration.ofSeconds(5)) // Consider call slow after 5s
        ...
        CircuitBreakerConfig youtubeConfig = CircuitBreakerConfig.custom()
    ...
    public RetryRegistry retryRegistry() {
        ...
        RetryConfig binomRetryConfig = RetryConfig.custom()
                .maxAttempts(3)
        ...
        RetryConfig youtubeRetryConfig = RetryConfig.custom()
                .maxAttempts(2)
