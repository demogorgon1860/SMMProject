...
/**
 * Comprehensive Hibernate optimization configuration Handles batch processing, query plan caching,
 * second-level caching, and monitoring
 */
@Configuration
@Slf4j
public class HibernateOptimizationConfig {
    ...
    public HibernatePropertiesCustomizer hibernatePropertiesCustomizer() {
        return (properties) -> {
            ...
            properties.put(
                    "hibernate.query.plan_parameter_metadata_max_size", queryPlanCacheSize / 16);
            ...
            if (useSecondLevelCache) {
                ...
                properties.put(
                        ConfigSettings.PROVIDER, "org.ehcache.jsr107.EhcacheCachingProvider");
    ...
    public CacheManager hibernateCacheManager() {
        ...
        try {
            ...
            MutableConfiguration<Object, Object> entityCacheConfig =
                    new MutableConfiguration<>()
                            .setExpiryPolicyFactory(
                                    CreatedExpiryPolicy.factoryOf(Duration.THIRTY_MINUTES))
                            .setStoreByValue(false)
                            .setStatisticsEnabled(true);

            // Configure cache for query results
            MutableConfiguration<Object, Object> queryCacheConfig =
                    new MutableConfiguration<>()
                            .setExpiryPolicyFactory(
            ...
            cacheManager.createCache(
                    "com.smmpanel.entity.ConversionCoefficient", entityCacheConfig);
            cacheManager.createCache(
                    "org.hibernate.cache.spi.QueryResultsRegion", queryCacheConfig);
    ...
    /**
     * Custom metadata builder contributor for advanced Hibernate configuration Note:
     * MetadataBuilderContributor was removed in newer Hibernate versions Hibernate configuration is
     * now handled through standard Spring Boot properties
     */
    ...
    */
        ...
        public Health health() {
            try {
                ...
                if (!statistics.isStatisticsEnabled()) {
                    return Health.up().withDetail("statistics", "disabled").build();
                }
                ...
                double cacheHitRatio =
                        statistics.getSecondLevelCacheHitCount() > 0
                ...
                // Note: Slow query count check removed as getSlowQueryCount() is not available in
                // this Hibernate version
    ...
    public static class HibernateStatisticsMonitor {
        ...
        @Scheduled(
                fixedRateString = "#{${hibernate.statistics.log-interval-minutes:10} * 60 * 1000}")
        public void logStatistics() {
            try {
                ...
                log.info(
                        "Query Execution Max Time Query: {}",
                ...
                if (statistics.getSecondLevelCacheHitCount() > 0
        ...
        @Scheduled(
                fixedRateString =
                        "#{${hibernate.statistics.reset-interval-hours:24} * 60 * 60 * 1000}")
