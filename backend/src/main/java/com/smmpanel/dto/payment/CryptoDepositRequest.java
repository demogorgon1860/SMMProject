 ...
 *
 * <p>VALIDATION FEATURES: - Balance amount validation with fraud detection - Cryptocurrency address
 * validation with checksum verification - Currency-specific limits and precision - Malicious
 * address detection
 */
@Data
@Builder
...
public class CryptoDepositRequest {
    ...
    @NotNull(message = "Amount is required") @BalanceAmount(
    ...
    @Pattern(regexp = "^[\\p{L}\\p{N}\\s.,!?\\-]*$", message = "Notes contain invalid characters")
    private String notes;

    @Builder.Default private Boolean notifyOnConfirmation = true;
