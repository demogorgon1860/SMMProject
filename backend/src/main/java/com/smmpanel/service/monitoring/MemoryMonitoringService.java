...
/**
 * Memory Monitoring Service Monitors JVM memory usage and provides metrics for Kafka consumer
 * threads
 */
@Slf4j
@Service
    ...
    public static class MemoryUsageSummary {
        ...
        public String getFormattedSummary() {
            return String.format(
                    "Memory Usage: Heap[used=%dMB, committed=%dMB, max=%dMB], NonHeap[used=%dMB,"
                            + " committed=%dMB]",
                    heapUsed >> 20,
                    heapCommitted >> 20,
                    heapMax >> 20,
