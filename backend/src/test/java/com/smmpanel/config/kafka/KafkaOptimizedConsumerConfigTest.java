...
/**
 * Test for Kafka Optimized Consumer Configuration Verifies throughput requirements and
...
class KafkaOptimizedConsumerConfigTest {
    ...
    void shouldHaveOrderEventConsumerFactory() {
        ConsumerFactory<String, Object> factory =
                (ConsumerFactory<String, Object>)
                        applicationContext.getBean("orderEventConsumerFactory");
    ...
    void shouldHaveVideoProcessingBatchConsumerFactory() {
        ConsumerFactory<String, Object> factory =
                (ConsumerFactory<String, Object>)
                        applicationContext.getBean("videoProcessingBatchConsumerFactory");
    ...
    void shouldHavePaymentConfirmationConsumerFactory() {
        ConsumerFactory<String, Object> factory =
                (ConsumerFactory<String, Object>)
                        applicationContext.getBean("paymentConfirmationConsumerFactory");
        ...
        assertThat(factory.getConfigurationProperties())
                ...
                .containsEntry(
                        ConsumerConfig.GROUP_ID_CONFIG, "smm-payment-confirmations-realtime-group");
    }
