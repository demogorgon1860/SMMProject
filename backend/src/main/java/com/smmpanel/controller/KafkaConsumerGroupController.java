...
import com.smmpanel.service.KafkaConsumerGroupManagementService;
import com.smmpanel.service.KafkaConsumerGroupManagementService.*;
 ...
 *
 * Provides REST endpoints for consumer group management:
 * 1. Consumer group health monitoring
 * 2. Consumer group information retrieval
 * 3. Consumer group administrative operations
 * 4. Partition assignment monitoring
 * 5. Consumer lag tracking and alerting
 */
@Slf4j
@RestController
@RequestMapping("/admin/kafka/consumer-groups")
@RequiredArgsConstructor
@Tag(name = "Kafka Consumer Group Management", 
...
public class KafkaConsumerGroupController {
    ...
    @GetMapping
    @Operation(summary = "List all consumer groups", 
    ...
    @Operation(summary = "Check consumer group health", 
    ...
    @Operation(summary = "Start consumer group", 
    ...
    @Operation(summary = "Stop consumer group", 
    ...
    @GetMapping("/stats")
    @Operation(summary = "Get consumer group management statistics", 
    ...
    @Operation(summary = "Get consumer group health summary", 
    ...
    public ResponseEntity<Map<String, Object>> getHealthSummary() {
        ...
        try {
            ...
            summary.put("healthPercentage", groups.isEmpty() ? 100.0 : (healthyGroups * 100.0 / groups.size()));
            summary.put("totalLag", groups.stream().mapToLong(ConsumerGroupSummary::getTotalLag).sum());
    ...
    @Operation(summary = "Get consumer group lag information", 
    ...
    public ResponseEntity<Map<String, Object>> getConsumerGroupLag(
        ...
        try {
            ...
            lagInfo.put("averageLagPerPartition", 
                    info.getPartitionLags().isEmpty() ? 0.0 : 
    ...
    @Operation(summary = "Get consumer group partition assignments", 
