...
/**
 * Comprehensive tests for optimistic locking functionality Tests version increment behavior and
...
public class OptimisticLockingTest {
    ...
    @Autowired private BalanceTransactionRepository balanceTransactionRepository;
    ...
    public void setupOptimisticLockingTest() {
        ...
        log.info(
                "Test data setup completed - User ID: {}, Service ID: {}",
                testUser.getId(),
                testService.getId());
    }
    ...
    public void testUserVersionIncrement() {
        ...
        if (initialVersion != null) {
            assertTrue(newVersion > initialVersion, "Version should be incremented after update");
        }

        // Verify the update was persisted
        assertEquals(originalBalance.add(BigDecimal.valueOf(100)), updatedUser.getBalance());
    ...
    public void testConcurrentModificationDetection() throws InterruptedException {
                ...
                executor.submit(
                        () -> {
                            try {
                                ...
                                log.info(
                                        "Thread 1: Loaded user with version {}",
                                        user1.getVersion());
                ...
                executor.submit(
                        () -> {
                            try {
                                ...
                                log.info(
                                        "Thread 2: Loaded user with version {}",
                                        user2.getVersion());
        ...
        if (hasOptimisticLockingException) {
            ...
            log.info(
                    "ℹ️ No optimistic locking exception occurred - this may be due to timing or"
    ...
    public void testVersionPersistenceAfterFlush() {
        ...
        for (int i = 1; i <= 3; i++) {
            ...
            if (versionBeforeUpdate != null) {
                assertTrue(
                        currentVersion >= versionBeforeUpdate + i,
