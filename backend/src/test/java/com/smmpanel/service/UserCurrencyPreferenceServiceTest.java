...
class UserCurrencyPreferenceServiceTest {
    ...
    @Mock private Cache userCurrencyCache;

    @InjectMocks private UserCurrencyPreferenceService userCurrencyPreferenceService;
    ...
    void updateUserPreferredCurrency_InvalidCurrency_ThrowsException() {
        ...
        assertThrows(
                ...
                () ->
                        userCurrencyPreferenceService.updateUserPreferredCurrency(
                                TEST_USER_ID, invalidCurrency));
    ...
    void convertFromUserCurrency_ValidConversion_ReturnsResult() {
        ...
        CurrencyConversionResultDto expectedResult =
        ...
        CurrencyConversionResultDto result =
                userCurrencyPreferenceService.convertFromUserCurrency(
                                ...
                                request ->
                                        request.getAmount().compareTo(amount) == 0
                                                && request.getFromCurrency()
                                                        .equals(USER_PREFERRED_CURRENCY)
    ...
    void convertToUserCurrency_ValidConversion_ReturnsResult() {
        ...
        CurrencyConversionResultDto result =
                userCurrencyPreferenceService.convertToUserCurrency(
    ...
    void getExchangeRateFromUserCurrency_ValidCurrencies_ReturnsRate() {
        ...
        BigDecimal rate =
                userCurrencyPreferenceService.getExchangeRateFromUserCurrency(
                        TEST_USER_ID, TARGET_CURRENCY);
    ...
    void getExchangeRateToUserCurrency_ValidCurrencies_ReturnsRate() {
        ...
        BigDecimal rate =
                userCurrencyPreferenceService.getExchangeRateToUserCurrency(
                        TEST_USER_ID, sourceCurrency);
                ...
                result.stream()
                        ...
                        .anyMatch(
                                info ->
                                        info.getName()
                                                .contains(
                                                        "Euro")); // EUR currency has "Euro" in the
        // name
