...
/** Perfect Panel API Integration Tests Tests Perfect Panel API compatibility and performance */
@SpringBootTest
@ActiveProfiles("test")
@Transactional
public class PerfectPanelApiTest {
    ...
    void testConcurrentRequests() throws Exception {
        ...
        for (Long responseTime : responseTimes) {
            assertTrue(
                    responseTime < 200,
                    "Response time should be under 200ms, was: " + responseTime);
        }
        ...
        assertTrue(
                avgResponseTime < 100,
                "Average response time should be under 100ms, was: " + avgResponseTime);
    }
    ...
    void testPerfectPanelResponseFormat() throws Exception {
        ...
        assertTrue(
                ...
                "Balance should have 2 decimal places: " + balance);
    }
}
