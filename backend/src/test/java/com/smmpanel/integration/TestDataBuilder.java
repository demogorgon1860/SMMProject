...
public class TestDataBuilder {
     ...
     */
    public static Service.ServiceBuilder serviceBuilder(String name, String category, BigDecimal price) {
        return Service.builder()
            .name(name)
            .category(category)
            .pricePer1000(price)
     ...
     */
    public static Order.OrderBuilder orderBuilder(User user, Service service, String link, int quantity) {
