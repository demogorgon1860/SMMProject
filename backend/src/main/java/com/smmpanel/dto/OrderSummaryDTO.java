 ...
 * 
 * Features:
 * 1. Minimal data transfer - only essential fields
 * 2. Prevents N+1 queries by including joined data
 * 3. Optimized for dashboard and listing views
 * 4. Reduces memory usage compared to full entities
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
public class OrderSummaryDTO {
    ...
    public long getAgeInHours() {
        return createdAt != null ? 
            java.time.Duration.between(createdAt, LocalDateTime.now()).toHours() : 0;
    }
}