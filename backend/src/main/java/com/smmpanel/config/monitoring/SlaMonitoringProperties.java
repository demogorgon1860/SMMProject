...
public class SlaMonitoringProperties {
    ...
    @NotNull private Duration initialDelay = Duration.ofSeconds(30);
    ...
    public static class Thresholds {
        ...
        @NotNull private Duration warning = Duration.ofMinutes(5);

        /** Critical threshold for order processing time */
        @NotNull private Duration critical = Duration.ofMinutes(15);
    }
    ...
    public static class CompletionThresholds {
        ...
        @NotNull private Duration warning = Duration.ofDays(1);

        /** Critical threshold for order completion time */
        @NotNull private Duration critical = Duration.ofDays(2);
    }
