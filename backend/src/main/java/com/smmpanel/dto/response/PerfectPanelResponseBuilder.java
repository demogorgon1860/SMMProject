...
/**
 * Perfect Panel Response Builder
 * Ensures consistent response formatting that matches Perfect Panel API exactly
 */
@Slf4j
@Component
public class PerfectPanelResponseBuilder {
     ...
     * Format: {"order": 12345, "status": "In progress", "remains": 500, "start_count": 1000, "charge": "10.50"}
     */
     ...
     * Format: {"balance": "45.67", "currency": "USD"}
     */
     ...
     * Format: Array of service objects with exact field names
     */
    ...
    /**
     * Build success response for operations like cancel/refill
     * Format: {"cancel": 12345, "status": "Success"}
     */
